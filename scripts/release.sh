...
# =============================================================================
# release.sh — Automates the full release pipeline for Mentorly
#
...
#   9. Pushes the updated appcast.xml to the releases repo (your-releases-repo)
#
# Usage:
...
GITHUB_REPO="brettr7388/Mentorly"  # releases (DMGs) + appcast.xml are published here
...
gh release create "${TAG}" "${DMG_PATH}" \
    ...
    --notes "Mentorly v${MARKETING_VERSION}" \
    --latest

# ── Step 9: Push appcast.xml to the releases repo ───────────────────────────
# The appcast lives in your releases repo (the releases repo), not in the
